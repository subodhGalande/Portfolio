...
const Navbar = () => {
  return (
    <nav class="  flex sm:mx-auto items-baseline justify-between mt-8 max-w-7xl px-4 sm:px-8 lg:px-12 ">
      <NavLink to="/">
        <h1 class="font-logo text-xs md:text-sm lg:text-base font-medium text-white">
          Subodh.
        </h1>
      </NavLink>
